...
builder.Services.AddSingleton<MediaSettingsProvider>();
builder.Services.AddSingleton<IMediaControlService>(provider =>
	MediaControlServiceFactory.Create(provider.GetRequiredService<MediaSettingsProvider>()));
var plugin = builder
	.UseMacroDeckLogging()
