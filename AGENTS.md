...
src/ScreenControl/       same shape: DDC monitor service (Monitors/, with gamma-ramp software brightness and caps-aware input cycling), Win32 window/desktop service (Windows/), 14 actions, 6 variables
